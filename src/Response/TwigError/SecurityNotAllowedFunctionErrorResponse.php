...
final class SecurityNotAllowedFunctionErrorResponse extends AbstractTwigErrorResponse
{
    public const MESSAGE = 'bitbag_sylius_mail_template_plugin.ui.not_allowed_twig_function';
