...
const [bitbagMailTemplateShop, bitbagMailTemplateAdmin] = require('../../webpack.config');
...
module.exports = [shopConfig, adminConfig, bitbagMailTemplateShop, bitbagMailTemplateAdmin];
